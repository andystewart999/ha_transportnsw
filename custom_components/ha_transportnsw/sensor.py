...
class TransportNSWSensor(CoordinatorEntity, SensorEntity):
    ...
    def __init__(
        ...
        description: TransportNSWSensorEntityDescription,
        config_entry: TransportNSWConfigEntry,
    ) -> None:
        """Initialise sensor."""
    ...
    def native_value(self) -> StateType:
        ...
        return self.entity_description.state_fn(self.coordinator)
...
class TransportNSWSubentrySensor(CoordinatorEntity, SensorEntity):
    ...
    def native_value(self) -> int | float | str | datetime:
        ...
        if journey_data is not None:
            ...
            value = extract_from_hierarchy(
                obj=journey_data, path=self.entity_description.state_path
            )
    ...
    def icon(self) -> str:
        ...
        if journey_data is not None:
            ...
            if self.entity_description.key in [
                ...
                return OCCUPANCY_ICONS.get(
                    occupancy, ["mdi:account-question", "Unknown"]
                )[0]
    ...
    def available(self) -> bool:
        ...
        return journey_data is not None
    ...
    def extra_state_attributes(self):
        ...
        try:
            ...
            if journey_data is not None:
                ...
                attrs["origin_id"] = extract_from_hierarchy(
                    obj=journey_data, path="origin_detail.stop_id"
                )
                attrs["destination_id"] = extract_from_hierarchy(
                    obj=journey_data, path="destination_detail.stop_id"
                )
