class VehicleOccupancyCard extends HTMLElement {
  static getStubConfig() {
      return { entity: "", title: "Vehicle occupancy", attribute: "occupancy_detail", "max_carriage_width": 80 }
  }

  static getConfigForm() {
    console.log("getConfigForm_v2")
    return {
      schema: [
...
//        { name: "entity", required: true, selector: { entity: {} } },
        ...
        { name: "attribute", required: false, selector: { text: {} } },
        { name: "max_carriage_width", required: false, selector: {number: {min: 32, max: 128, mode: "box", unit_of_measurement: "px"} } },
      ],
      computeHelper: (schema) => {
        switch (schema.name) {
          ...
          case "title":
            return "Set a title for the card";
          case "attribute":
            return "The sensor attribute that holds the detailed carriage occupancy data";
  ...
  set hass(hass) {
    ...
    if (!(this.config.attribute in stateObj.attributes)) {
      this.innerHTML = `
        <ha-card>
          <div class="card-content">
