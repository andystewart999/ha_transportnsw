    ...
    if config_entry.version == 1:
        ...
        for subentry in config_entry.subentries.values():
            if subentry.subentry_type == SUBENTRY_TYPE_JOURNEY:
                ...
                _LOGGER.error(f"in __init__/async_migrate_entry: '{subentry.title}' new_data = {new_data}")
                ...
                _LOGGER.error(f"new_options = {new_options}")
                ...
                _LOGGER.error(f"new_data = {new_data}")
        ...
        _LOGGER.debug(f"Migration to configuration version {config_entry.version} successful")
